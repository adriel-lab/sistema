...
$modal_open = false; // variável para armazenar o estado do modal
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if(mysqli_num_rows($result) == 1) {
    ...
    // Login inválido, mostrar mensagem de erro e manter o modal aberto
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li>  <button class="get-a-quote" id="open-modal">Login</button></li>
...
<!-- começo testimonial item -->


    <?php
      $sql = "SELECT * FROM assistants LIMIT 8";
    ...
    <div class="swiper-slide">
      ...
      <img src="/sistema/upload/<?php echo $row['image']; ?>" class="testimonial-img" alt="">
        <h3><?php echo $row['name']; ?></h3>
        <h4><?php echo $row['function']; ?></h4>
        <div class="stars">
          <?php
            $stars = $row['stars'];
            for ($i = 0; $i < $stars; $i++) {
...
<body>
  ...
  <script>
    ...
    // Adicionar o evento de clique para fechar o modal
